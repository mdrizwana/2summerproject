    ...
    <div class="main-container">
        ...
        <aside class="hit_sidebar open_sidbar sidebar-slide-push">
            ...
            <li class="nav-item dropdown dmenu">
             <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown"><span class="nav-icon"><i class="glyphicon glyphicon-wrench" aria-hidden="true"></i></span>
              <span class="remove_text">Settings</span>
            </a>
