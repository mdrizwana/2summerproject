...
<div class="container">
    	...
    	<form role="form" class="form-inline col-md-9 go-right" style="color: Green;background-color:#FAFAFF;border-radius:0px 100px 100px 22px;margin-left:800px " action="RegisterServlet" method="POST" >
			<h2>REGISTER</h2>
        ...
        <br>
		<div class="form-group">
			<input  name="phoneNumber" id="phone" type="tel"  pattern="[0-9]{10}" placeholder="Phone number" class="form-control" required>
       ...
       <p>Gender:</p>
        ...
        <br><br>
         <div class="form-group">
    		<input name="email" type="email" class="form-control" style="width:400px;" placeholder="Registered email" required>
...
<font size="5" color="Blue"><input type="submit" value="Back to home page"></font></form>
        </div>
</body>
</html>
